...
interface GameRoom {
  ...
  processedActions: Set<string>; // Set of processed action IDs
}
...
io.on('connection', (socket) => {
  ...
  socket.on('provideGameState', (roomId: string, gameState: any, targetSocketId: string) => {
    try {
  ...
  // Update game state
  socket.on('updateGameState', (roomId: string, gameState: any) => {
    try {
